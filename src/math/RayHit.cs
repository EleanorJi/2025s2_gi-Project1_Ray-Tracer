...
namespace RayTracer
{
    ...
    public class RayHit
    {
        ...
        public RayHit(Vector3 position, Vector3 normal, Vector3 incident, Material material, TextureCoord texCoord = default)
        {
        ...
        public TextureCoord TexCoord { get { return this.texCoord; } }
    }
}
